...
var helpers = {
  ...
  setTitle: function (title) {
	...
	var listTitle1 = document.getElementById('item-detalhe-title');
    listTitle1.textContent = title;
	  
	var listTitle2 = document.getElementById('item-sobre-title');
    listTitle2.textContent = title;
  },
...
document.querySelector('#btnsobre').addEventListener('click', helpers.goTo);

document.querySelector('#btnpontosturisticos').addEventListener('click', helpers.goTo);

document.querySelector('#btnhospedagem').addEventListener('click', helpers.goTo);

document.querySelector('#btnrestaurantes').addEventListener('click', helpers.goTo);

document.querySelector('#btntransportes').addEventListener('click', helpers.goTo);

document.querySelector('#btnutilidadepublica').addEventListener('click', helpers.goTo);

document.querySelector('#bteneventos').addEventListener('click', helpers.goTo);
